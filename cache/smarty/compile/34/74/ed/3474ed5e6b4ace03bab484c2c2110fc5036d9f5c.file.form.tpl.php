<?php /* Smarty version Smarty-3.1.19-dev, created on 2017-12-30 17:54:21
         compiled from "/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/import/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19099936095a47c4bd88e416-81771593%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3474ed5e6b4ace03bab484c2c2110fc5036d9f5c' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/import/helpers/form/form.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19099936095a47c4bd88e416-81771593',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a47c4bd9f7ab6_81115848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a47c4bd9f7ab6_81115848')) {function content_5a47c4bd9f7ab6_81115848($_smarty_tpl) {?>
<div class="leadin"></div>
<?php if ($_smarty_tpl->tpl_vars['module_confirmation']->value) {?>
	<div class="alert alert-success clearfix">
		<?php echo smartyTranslate(array('s'=>'Your file has been successfully imported into your shop. Don\'t forget to re-build the products\' search index.'),$_smarty_tpl);?>
		...
		<div class="panel">
			...
			<div class="alert alert-info">
				<ul class="list-unstyled">
					<li><?php echo smartyTranslate(array('s'=>'You can read information about importing at:'),$_smarty_tpl);?>
...
" method="post" enctype="multipart/form-data" class="form-horizontal">
				<div class="form-group">
					<label for="entity" class="control-label col-lg-4"><?php echo smartyTranslate(array('s'=>'What do you want to import?'),$_smarty_tpl);?>
 </label>
					<div class="col-lg-8">
...
"<?php if ($_smarty_tpl->tpl_vars['entity_selected']->value==$_smarty_tpl->tpl_vars['i']->value) {?> selected="selected"<?php }?>>
				...
				<div class="form-group" id="csv_file_uploader">
					<label for="file" class="control-label col-lg-4"><?php echo smartyTranslate(array('s'=>'Select a file to import'),$_smarty_tpl);?>
</label>
					<div class="col-lg-8">
...
&amp;ajax=1&amp;action=uploadCsv" class="hide" />
						<button class="ladda-button btn btn-default" data-style="expand-right" data-size="s" type="button" id="file-add-button">
							...
							<?php echo smartyTranslate(array('s'=>'Upload'),$_smarty_tpl);?>
						...
						<p class="help-block">
							<?php echo smartyTranslate(array('s'=>'Allowed formats: .csv, .xls, .xlsx, .xlst, .ods, .ots'),$_smarty_tpl);?>
.<br/>
							<?php echo smartyTranslate(array('s'=>'Only UTF-8 and ISO 8859-1 encodings are allowed'),$_smarty_tpl);?>
.<br/>
							<?php echo smartyTranslate(array('s'=>'You can also upload your file via FTP to the following directory: %s .','sprintf'=>array($_smarty_tpl->tpl_vars['path_import']->value)),$_smarty_tpl);?>
				...
				<div class="form-group" id="csv_files_history" style="display:none;" >
					<div class="panel">
						<div class="panel-heading">
							<?php echo smartyTranslate(array('s'=>'History of uploaded files'),$_smarty_tpl);?>
...
<?php } else { ?>,<?php }?>" />
								<div class="help-block"><?php echo smartyTranslate(array('s'=>'e.g. '),$_smarty_tpl);?>
 red.jpg; blue.jpg; green.jpg</div>
							</div>
						</div>
					</div>
				</div>
...
">
				...
				<div class="form-group">
					<label for="forceIDs" class="control-label col-lg-4">
						<span data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'If you enable this option, your imported items\' ID number will be used as-is. If you do not enable this option, the imported ID numbers will be ignored, and PrestaShop will instead create auto-incremented ID numbers for all the imported items.'),$_smarty_tpl);?>
">
				...
				<div class="form-group">
					<label for="sendemail" class="control-label col-lg-4">
						<span data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Sends an email to let you know your import is complete. It can be useful when handling large files, as the import may take some time.'),$_smarty_tpl);?>
">
						<?php echo smartyTranslate(array('s'=>'Send notification email'),$_smarty_tpl);?>
</label>
					</span>
					<div class="col-lg-8">
						<label class="switch-light prestashop-switch fixed-width-lg">
		...
		<div class="panel">
			...
			<div class="list-group">
				...
				<a class="list-group-item _blank" href="../docs/csv_import/manufacturers_import.csv">
					<?php echo smartyTranslate(array('s'=>'Sample Brands file'),$_smarty_tpl);?>
				...
				<a class="list-group-item _blank" href="../docs/csv_import/store_contacts.csv">
					<?php echo smartyTranslate(array('s'=>'Sample Store Contacts file'),$_smarty_tpl);?>
