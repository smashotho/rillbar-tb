<?php /* Smarty version Smarty-3.1.19-dev, created on 2017-12-27 15:58:22
         compiled from "/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/performance/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21072032705a43b50ef1f895-41772483%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2767325020217dc5928ecd91295fc7ab53fdc48' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/performance/helpers/form/form.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
    'e51354cefd47250016e7c9898cb3b4b8c6293fa3' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/helpers/form/form.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
    'd3a0809610e231ca584bdf9b6e011ccf262d8b7c' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/helpers/form/form_group.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21072032705a43b50ef1f895-41772483',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a43b51076aeb9_47068682',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a43b51076aeb9_47068682')) {function content_5a43b51076aeb9_47068682($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/vendor/smarty/smarty/libs/plugins/function.counter.php';
?>
...
]<?php } else { ?>[13,44]<?php }?>, addTagPrompt: '<?php if (isset($_smarty_tpl->tpl_vars['input']->value['tagPrompt'])) {?><?php echo strtr($_smarty_tpl->tpl_vars['input']->value['tagPrompt'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
<?php echo smartyTranslate(array('s'=>'Add tag','js'=>1),$_smarty_tpl);?>
<?php }?>'});
...
<?php }?>">
												...
												<?php if (isset($_smarty_tpl->tpl_vars['input']->value['disableKeys'])&&is_array($_smarty_tpl->tpl_vars['input']->value['disableKeys'])) {?>
													<script type="text/javascript">
														$().ready(function() {
															$('#<?php if (isset($_smarty_tpl->tpl_vars['input']->value['id'])) {?><?php echo strtr($_smarty_tpl->tpl_vars['input']->value['id'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
<?php } else { ?><?php echo strtr($_smarty_tpl->tpl_vars['input']->value['name'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
<?php }?>').keydown(function (e) {
																<?php  $_smarty_tpl->tpl_vars['disabledKey'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['disabledKey']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['disableKeys']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['disabledKey']->key => $_smarty_tpl->tpl_vars['disabledKey']->value) {
$_smarty_tpl->tpl_vars['disabledKey']->_loop = true;
?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add tag'),$_smarty_tpl);?>
<?php }?>'});
													$('#<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
_form').submit( function() {
														$(this).find('#'+input_id).val($('#'+input_id).tagify('serialize'));
...
");
												...
												editor.getSession().setMode("ace/mode/<?php if (isset($_smarty_tpl->tpl_vars['input']->value['mode'])) {?><?php echo strtr($_smarty_tpl->tpl_vars['input']->value['mode'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
<?php } else { ?>javascript<?php }?>");
												editor.setOptions({
													fontSize: <?php if (isset($_smarty_tpl->tpl_vars['input']->value['fontSize'])) {?><?php echo intval($_smarty_tpl->tpl_vars['inpout']->value['fontSize']);?>
<?php } else { ?>14<?php }?>,
													minLines: <?php if (isset($_smarty_tpl->tpl_vars['input']->value['minLines'])) {?><?php echo intval($_smarty_tpl->tpl_vars['input']->value['minLines']);?>
<?php } else { ?>10<?php }?>,
													maxLines: <?php if (isset($_smarty_tpl->tpl_vars['input']->value['maxLines'])) {?><?php echo intval($_smarty_tpl->tpl_vars['input']->value['maxLines']);?>
<?php } else { ?>10<?php }?>,
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '21072032705a43b50ef1f895-41772483');
content_5a43b510100c42_00623339($_smarty_tpl);
...
" id="testMemcachedServer" class="btn btn-default"/>
 ...
 $_from = $_smarty_tpl->tpl_vars['memcached_servers']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
				...
				<?php if (isset($_smarty_tpl->tpl_vars['redis_servers']->value)&&$_smarty_tpl->tpl_vars['redis_servers']->value) {?>
					<div class="form-group">
						<table class="table">
							...
							<tbody>
							<?php  $_smarty_tpl->tpl_vars['server'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['server']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['redis_servers']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['server']->key => $_smarty_tpl->tpl_vars['server']->value) {
$_smarty_tpl->tpl_vars['server']->_loop = true;
?>
								<tr>
...
')) {return false;}"><i class="icon-minus-sign-alt"></i> <?php echo smartyTranslate(array('s'=>'Remove'),$_smarty_tpl);?>
 ...
 $_smarty_tpl->tpl_vars['idModule'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['moduleSettings']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['module']->key => $_smarty_tpl->tpl_vars['module']->value) {
$_smarty_tpl->tpl_vars['module']->_loop = true;
 $_smarty_tpl->tpl_vars['idModule']->value = $_smarty_tpl->tpl_vars['module']->key;
?>
							<tr>
								<td>
 ...
 $_smarty_tpl->tpl_vars['hookName'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['module']->value['hooks']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['enabled']->_loop = true;
 $_smarty_tpl->tpl_vars['hookName']->value = $_smarty_tpl->tpl_vars['enabled']->key;
?>
										&nbsp;
										<span
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19-dev, created on 2017-12-27 15:58:24
         compiled from "/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a43b510100c42_00623339')) {function content_5a43b510100c42_00623339($_smarty_tpl) {?>
