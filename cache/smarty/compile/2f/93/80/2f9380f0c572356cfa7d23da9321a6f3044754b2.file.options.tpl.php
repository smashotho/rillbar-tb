<?php /* Smarty version Smarty-3.1.19-dev, created on 2017-12-27 16:32:48
         compiled from "/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/order_preferences/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3067350765a43bd20b74e46-39538363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2f9380f0c572356cfa7d23da9321a6f3044754b2' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/controllers/order_preferences/helpers/options/options.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
    'f6893b6afbc421c1679dd09a8087f37ca81ae605' => 
    array (
      0 => '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/admin_smash/themes/default/template/helpers/options/options.tpl',
      1 => 1503023000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3067350765a43bd20b74e46-39538363',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a43bd212174d6_41662491',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a43bd212174d6_41662491')) {function content_5a43bd212174d6_41662491($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/vendor/smarty/smarty/libs/plugins/function.counter.php';
if (!is_callable('smarty_modifier_escape')) include '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/vendor/smarty/smarty/libs/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include '/Users/admin/Documents/Rillbar/Rillbar Thirtybees/rillbar-tb/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?>
...
"<?php if (isset($_smarty_tpl->tpl_vars['field']->value['id'])) {?>
												   id="<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
"<?php }?>
												   size="<?php if (isset($_smarty_tpl->tpl_vars['field']->value['size'])) {?><?php echo intval($_smarty_tpl->tpl_vars['field']->value['size']);?>
<?php } else { ?>5<?php }?>"
...
<?php }?>"
												   <?php if (isset($_smarty_tpl->tpl_vars['field']->value['placeholder'])&&$_smarty_tpl->tpl_vars['field']->value['placeholder']) {?>placeholder="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['placeholder'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"<?php }?>
...
" value=""<?php if (isset($_smarty_tpl->tpl_vars['field']->value['autocomplete'])&&!$_smarty_tpl->tpl_vars['field']->value['autocomplete']) {?> autocomplete="off"<?php }?> />
									...
									<?php } elseif ($_smarty_tpl->tpl_vars['field']->value['type']=='textarea') {?>
										<div class="col-lg-9">
											<textarea class="textarea-autosize" name="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" cols="<?php echo intval($_smarty_tpl->tpl_vars['field']->value['cols']);?>
" rows="<?php echo intval($_smarty_tpl->tpl_vars['field']->value['rows']);?>
...
");
													...
													editor.getSession().setMode("ace/mode/<?php if (isset($_smarty_tpl->tpl_vars['field']->value['mode'])) {?><?php echo strtr($_smarty_tpl->tpl_vars['field']->value['mode'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
<?php } else { ?>javascript<?php }?>");
													editor.setOptions({
														fontSize: <?php if (isset($_smarty_tpl->tpl_vars['field']->value['fontSize'])) {?><?php echo intval($_smarty_tpl->tpl_vars['field']->value['fontSize']);?>
<?php } else { ?>14<?php }?>,
														minLines: <?php if (isset($_smarty_tpl->tpl_vars['field']->value['minLines'])) {?><?php echo intval($_smarty_tpl->tpl_vars['field']->value['minLines']);?>
<?php } else { ?>10<?php }?>,
														maxLines: <?php if (isset($_smarty_tpl->tpl_vars['field']->value['maxLines'])) {?><?php echo intval($_smarty_tpl->tpl_vars['field']->value['maxLines']);?>
<?php } else { ?>10<?php }?>,
